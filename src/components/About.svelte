...
<!-- data-aos="fade-up" data-aos-duration="500" data-aos-once="true" -->
  <div class="container text-lg rounded-lg shadow-lg bg-gray-200 p-12" style="max-width: 70rem;">
  <p class="my-3">
    We decided to set up this gofund me to support all the nurses and healthcare professionals who are on the front lines fighting the outbreak of COVID19. Its our friends, family members, neighbors, and even strangers.
  </p>
  <p class="my-3">
  ...
  <p class="my-3 font-bold">
    Email : <a href="mailto:nursesneedus@gmail.com" class="text-blue-700 hover:text-blue-800">nursesneedus@gmail.com</a>
  </p>
  <p class="my-3">
